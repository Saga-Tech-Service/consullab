    ...
    return (
        <footer className="bg-[#3a658f] pt-16 space-y-10 lg:space-y-20">
            <section className="containerConssulab  w-full justify-start items-start gap-8 flex flex-col lg:flex-row">
                ...
                <div className="w-full grid grid-cols-1 sm:flex flex-wrap justify-between items-start gap-16">

                    <div className="flex-1 flex-col justify-start items-start gap-6 inline-flex">
                        <div className="flex-col justify-start items-start gap-8 flex">
                            <h1 className="self-stretch text-white text-[28px] font-bold leading-[39.20px] font-montserrat">
                                {t("menu.title")}
                            </h1>
                            <div className="self-stretch h-36 flex-col justify-start items-start gap-4 flex">
                                <Link
                                    href={"/"}
                                    className="font-inter self-stretch text-white text-base font-normal leading-normal"
                                >
                                    {t("menu.home")}
                                </Link>
                                <Link
                        ...
                        <div className="flex-col justify-start items-start gap-8 flex">
                            ...
                            <div className="flex-col justify-start items-start gap-4 flex">
                                ...
                                <Link
                                    ...
                                    className="font-inter self-stretch text-white text-base font-normal underline leading-normal"
                                >
