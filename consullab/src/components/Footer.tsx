    ...
    return (
        <footer className="bg-[#3a658f] pt-16 space-y-10 lg:space-y-20">
            <section className="containerConssulab  w-full gap-8 flex flex-col lg:flex-row">
                ...
                <div className="w-full grid  grid-cols-2 md:flex justify-between flex-wrap gap-6 md:gap-16">

                    <div className="flex-col gap-8 flex">
                        <h1 className="text-white text-base md:text-[28px] font-bold leading-[39.20px] font-montserrat">
                            {t("menu.title")}
                        </h1>
                        <div className=" flex-col gap-4 flex">
                            <Link
                                href={"/"}
                                className="font-inter text-white text-sm md:text-base font-normal leading-normal"
                            >
                                {t("menu.home")}
                            </Link>
                            <Link
                    ...
                    <div className="flex-col gap-8 flex">
                        ...
                        <div className="flex-col gap-4 flex">
                            <Link
                                ...
                                className="font-inter text-white text-sm md:text-base font-normal underline leading-normal"
                            >
