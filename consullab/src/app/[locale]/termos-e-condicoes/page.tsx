...
const TermsConditions = () => {
    ...
    const t = useTypedTranslations("TermsConditions")
    const tFAQ = useTranslations("TermsConditions.accordion")
    const message = useMessages() as unknown as FAQ | null

    const KeysFAQ = message?.TermsConditions?.accordion ?
        Object.keys(message.TermsConditions.accordion) : []
