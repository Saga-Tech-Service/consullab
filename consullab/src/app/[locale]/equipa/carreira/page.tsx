    ...
    return (
        <main className="containerConssulab flex flex-col top-margin">
            ...
            <section className="lg:self-end lg:mt-[95px] lg:w-[488px] flex-col justify-start items-start lg:gap-[72px] inline-flex">
                <p className="self-stretch text-[#091622] text-base font-normal leading-normal font-inter">
                ...
                <Button variant={"outline"} className="font-montserrat text-[#091622] w-full lg:w-auto truncate ring-1 ring-[#091622] rounded-none text-sm lg:text-base font-semibold mt-6">
            ...
            <section className="flex-col justify-start items-start gap-4 inline-flex my-72">
                <p className="text-[#091622] text-lg font-bold font-montserrat leading-[25.20px]">Nossos benefícios</p>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-y-10 gap-x-4">
                <div className="flex-col justify-start items-start gap-6 inline-flex mb-10">
                    <Separator className="w-full h-[0px] border border-slate-500/90" />
                    <h5 className="self-stretch text-[#091622] font-montserrat text-sm lg:text-base font-semibold  leading-normal">
            ...
            <section className="h-auto flex-col justify-start items-start gap-8 inline-flex mt-[184px] mb-[144px]">
                <h3 className="font-montserrat self-stretch text-[#091622] text-xl md:text-2xl font-bold leading-7">OPORTUNIDADE DE CARREIRA EM DESTAQUE</h3>
                ...
                <nav className="flex-col justify-start items-start gap-6 inline-flex w-full max-w-[800px]">
                    <Link href={"/equipa/carreira/uxiliar-de-contabilidade"} className="flex justify-between items-center w-full">
                        <p className="text-[#173049] font-inter text-lg font-normal leading-[27px]">Auxiliar de contabilidade</p>
