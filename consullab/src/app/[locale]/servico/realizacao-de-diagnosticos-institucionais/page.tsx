...
const ServiceConsullab = () => {
    const t = useTypedTranslations("servicesDetails1");
    const tDatails = useTypedTranslations("DiagnosticsServiceDetails1");
    const tNews = useTranslations("itemsNews1");
    const tService = useTranslations("servicesList");
    const messages = useMessages();
    const Keys = Object.keys(messages.itemsNews1);
