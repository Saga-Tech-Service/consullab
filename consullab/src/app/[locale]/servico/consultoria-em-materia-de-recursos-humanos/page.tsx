...
const ServiceConsullab = () => {
    const t = useTypedTranslations("servicesDetails7");
    const tDatails = useTypedTranslations("DiagnosticsServiceDetails7");
    const tNews = useTranslations("itemsNews7");
    const tService = useTranslations("servicesList");
    const messages = useMessages();
    const Keys = Object.keys(messages.itemsNews7);
