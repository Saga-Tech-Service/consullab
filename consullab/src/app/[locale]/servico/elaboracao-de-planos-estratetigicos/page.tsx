...
const ServiceConsullab = () => {
    const t = useTypedTranslations("servicesDetails2");
    const tDatails = useTypedTranslations("DiagnosticsServiceDetails2");
    const tNews = useTranslations("itemsNews2");
    const tService = useTranslations("servicesList");

    const messages = useMessages();
    const Keys = Object.keys(messages.itemsNews2)
