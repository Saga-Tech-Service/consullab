...
const ServiceConsullab = () => {
    const t = useTypedTranslations("servicesDetails6");
    const tDatails = useTypedTranslations("DiagnosticsServiceDetails6");
    const tNews = useTranslations("itemsNews6");
    const tService = useTranslations("servicesList");
    const messages = useMessages();
    const Keys = Object.keys(messages.itemsNews6);
