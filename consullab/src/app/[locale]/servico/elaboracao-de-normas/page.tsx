...
const ServiceConsullab = () => {
    const t = useTypedTranslations("servicesDetails5");
    const tDatails = useTypedTranslations("DiagnosticsServiceDetails5");
    const tNews = useTranslations("itemsNews5");
    const tService = useTranslations("servicesList");
    const messages = useMessages();
    const Keys = Object.keys(messages.itemsNews5);
