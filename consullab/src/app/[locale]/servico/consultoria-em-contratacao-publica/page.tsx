...
const ServiceConsullab = () => {
    const t = useTypedTranslations("servicesDetails3");
    const tDatails = useTypedTranslations("DiagnosticsServiceDetails3");
    const tNews = useTranslations("itemsNews3");
    const tService = useTranslations("servicesList");
    const messages = useMessages();
    const Keys = Object.keys(messages.itemsNews3);
