        ...
        <main className="flex flex-col">
            <section className="flex flex-col w-full mx-auto max-w-max-width-consullab ">
                ...
                <h1 className="w-[814px] text-[#091622] text-5xl font-bold leading-[76.80px] mt-8">
                    Consultoria em Contratação <br /> Pública
                </h1>
                ...
                <section className="flex mt-8">
                    ...
                    <p className="flex flex-1 w-[488px] text-[#091622] text-lg font-normal leading-[27px]">
                        Actuamos em todos os domínios da contratação Pública auxiliando as  instituições públicas no processo de aquição de bens e serviços, bem como concessão  de serviços públicos ou bens de domínio público.
                    </p>
                </section>
                ...
                <span className="mt-12 flex w-[1216px] text-[#091622] text-[32px] font-bold leading-[44.80px]">
                    Consultoria em Contratação Pública abrange diversas áreas de trabalho
                </span>

                <section className="mt-[72px] h-[922px] flex-col justify-start items-start gap-[72px] inline-flex">
                    <TopicSection title="Realização de estudos" number="01">
                        <ul>
                            <li className="list-disc">
                                Identificação das necessidades aquisitivas da instituição;
                            </li>
                            <li className="list-disc">
                                Estudos de marcados;
                            </li>
                    ...
                    <TopicSection title="Condução de procedimentos de contratação pública" number="02">
                        <ul>
                            <li className="list-disc">
                                Elaboração de peças de procedimento;
                            </li>
                            <li className="list-disc">
                                Analise e avaliação de propostas;
                            </li>
                            <li className="list-disc">
                                Respostas a impugnações administrativas e judiciais.
                            </li>
                        </ul>
                    </TopicSection>
                    <TopicSection title="Concessões" number="03">
                        <ul>
                            <li className="list-disc">
                                Estruturação e condução de concessões de serviços públicos;
                            </li>
                            <li className="list-disc">
                                Estruturação e condução de concessões de bens de domínio público;
                            </li>
                            <li className="list-disc">
                                Estruturação e condução de procedimentos para parcerias público-privadas
                            </li>
                        </ul>
                    </TopicSection>
