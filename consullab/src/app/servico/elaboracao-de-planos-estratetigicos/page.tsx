...
const ElaboracaoPlanosEstratetigicos = () => {
    return (
        <main className="flex flex-col">
            <section className="flex flex-col w-full mx-auto max-w-max-width-consullab ">
                ...
                <h1 className="w-[814px] text-[#091622] text-5xl font-bold leading-[76.80px] mt-8">
                    Elaboração de Planos <br /> Estratégicos
                </h1>
                ...
                <section className="flex mt-8">
                    ...
                    <p className="flex flex-1 w-[488px] text-[#091622] text-lg font-normal leading-[27px]">
                        A gestão de qualquer instituição deve estar ligada a uma planificação  sistemática e sistematizada, com objectivos claros e meios para os materializar. A  Consullab actua igualmente no domínio da elaboração de planos estratégicos e no  monitoramento da sua execução.
                    </p>
                </section>
                ...
                <span className="mt-12 flex w-[1216px] text-[#091622] text-[32px] font-bold leading-[44.80px]">
                    Elaboração de Planos Estratégicos abrange diversas áreas de trabalho
                </span>

                <section className="mt-[72px] h-auto flex-col justify-start items-start gap-[72px] inline-flex">
                    <TopicSection title="Elaboração de planos estratégicos" number="01">
                        <ul>
                            <li className="list-disc">
                                Analise e determinação de novos mercados;

                            </li>
                            <li className="list-disc">
                                Criação de objetivos de medio e longo prazo;
                            </li>
                        </ul>
                    </TopicSection>
                    <TopicSection title="Elaboração de planos operacionais;" number="02">
                        <ul>
                            <li className="list-disc">
                                Criação de mecanismos de actuação da instituição;
                            </li>
                            <li className="list-disc">
                                Estruturação da área operacional;
                            </li>
                        </ul>
                    </TopicSection>
                </section>
...
export default ElaboracaoPlanosEstratetigicos;
