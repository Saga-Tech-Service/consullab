            ...
            <section className="flex flex-col w-full mx-auto max-w-max-width-consullab ">
                ...
                <section className="flex mt-8">
                    ...
                    <p className="flex flex-1 w-[488px] text-[#091622] text-lg font-normal leading-[27px]">
                        Apoiamos as instituições no domínio da gestão do capital humano,  atendendo a todas as suas facetas, desde os processos de recrutamento a elaboração  dos mais diversos documentos ligados ao capital humano elaboração de contratos,  gestão de contratos, gestão de conflitos, elaboração de planos de carreira, planos de  formação, avaliação do impacto das formações, diagnósticos etc.
                    </p>
                </section>
                ...
                <span className="mt-12 flex w-[1216px] text-[#091622] text-[32px] font-bold leading-[44.80px]">
                    Consultoria em Matéria de Recursos Humanos abrange diversas áreas de trabalho
                </span>

                <section className="mt-[72px] h-[922px] flex-col justify-start items-start gap-[72px] inline-flex">
                    <TopicSection title="Elaboração de documentos" number="01">
                        <ul>
                            ...
                            <li className="list-disc">
                                Elaboração de descritivo de funções.
                            </li>
                        </ul>
                    </TopicSection>
                    <TopicSection title="Gestão do capital humano" number="02">
                        <ul>
                            <li className="list-disc">
                                Condução de processos de recrutamento;
                            </li>
                            <li className="list-disc">
                                Gestão de contratos;
                            </li>
                    ...
                    <TopicSection title="Diagnostico formativo" number="03">
                        <ul>
                            ...
                            <li className="list-disc">
                                Avaliação do impacto das formações;
                            </li>
                        </ul>
                    </TopicSection>
